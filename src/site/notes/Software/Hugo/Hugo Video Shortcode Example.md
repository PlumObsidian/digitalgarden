---
{"dg-publish":true,"permalink":"/software/hugo/hugo-video-shortcode-example/","tags":["hugo","websites","video"]}
---


```
{{< video src="Big_Buck_Bunny_1080_10s_5MB.mp4" width="600" >}}

```

To create a shortcode like the above:

Create layouts/shortcode/video.html from [this]([hugo-theme-zen/layouts/shortcodes/video.html at main · frjo/hugo-theme-zen](https://github.com/frjo/hugo-theme-zen/blob/main/layouts/shortcodes/video.html))
